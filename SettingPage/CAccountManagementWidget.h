...
class CAccountManagementWidget : public QWidget
{
    Q_OBJECT
public:
    explicit CAccountManagementWidget(QWidget *parent = 0);
...
class CUserAddWidget : public QWidget
{
    Q_OBJECT
public:
    explicit CUserAddWidget(QWidget *parent = 0);
...
class CUserModifyWidget : public QWidget
{
    Q_OBJECT
public:
    explicit CUserModifyWidget(QWidget *parent = 0);
...
class CUserDeleteWidget : public QWidget
{
    Q_OBJECT
public:
    explicit CUserDeleteWidget(QWidget *parent = 0);
