...
public:
    ...
    */
    ...
    static QByteArray GetWriteRotateCompenSept(QString strRotateCompenSept);//写电机补偿步数命令
...
//    static const int sm_kiCmdReadParamFromDev = 0x0007;//读取仪器参数
    static const int sm_kiCmdWriteParamToDev = 0x0014;//写仪器参数
    static const int sm_kiCmdReadParamFromDev = 0x0015;//读取仪器参数
    ...
    static const int sm_kiCmdWriteRotateCompenSeptToDev = 0x0013;//写入电机补偿步数
    //命令参数
