...
class CalculateGreenComponent
{
public:
    CalculateGreenComponent();
    ~CalculateGreenComponent();
  ...
  */
    ...
    bool GetGrayscaleComponentSDAvg(QString strImagePath,QPoint qPoint,int iRectR,
  ...
  * @return
  */
    void RrawRect(cv::Mat &Mimage,QPoint qPoint,int iRectR,int iRectD,int iPos);
