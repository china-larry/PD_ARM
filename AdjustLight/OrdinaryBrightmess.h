...
signals:
    ...
    void SignalImportValueToUI(BrightnessOrdinaryValue sBrightnessValue);
     ...
     //发送校准后的亮度参数到UI显示
    void SignalCalibrationValueToUI(bool bIsSeccess,BrightnessOrdinaryValue sBrightnessValue);
...
public slots:
    ...
    //接收UI Calibration按钮槽
      ...
      * @return
      */
    bool GetLightValue(const int iCupType,const int iBrightNo,QPoint qCenterPoint,const int iStandardBright,
    ...
    * @return
    */
    bool OrdinaryCalibration(BrightnessOrdinaryValue &sBrightnessValue);
