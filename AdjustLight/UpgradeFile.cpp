...
quint8 UpgradeFile::parseUpgradeFile(const QString &strUpgradeFile)
{
    ...
    qInDataStream >> m_iodelCode >> m_imageCode >> m_ihwVersionMajor >> m_ihwVersionMinor
            >> m_iswVersionMajor >> m_iswVersionMinor
