...
void CLabelCommoBoxWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CLabelCommoBoxWidget *_t = static_cast<CLabelCommoBoxWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CLabelCommoBoxWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CLabelCommoBoxWidget::SignalCurrentSelectChange)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CLabelCommoBoxWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CLabelCommoBoxWidget.data,
      qt_meta_data_CLabelCommoBoxWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CLabelCommoBoxWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLabelCommoBoxWidget.stringdata0))
        return static_cast<void*>(const_cast< CLabelCommoBoxWidget*>(this));
