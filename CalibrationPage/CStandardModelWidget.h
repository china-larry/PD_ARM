...
class CStandardModelWidget : public QWidget
{
    Q_OBJECT
public:
    explicit CStandardModelWidget(QWidget *parent = 0);
...
private slots:
    ...
    void _SlotNo1LineEditWidgetChage();
    void _SlotNo2LineEditWidgetChage();
    void _SlotNo3LineEditWidgetChage();
    void _SlotNo4LineEditWidgetChage();
    void _SlotNo5LineEditWidgetChage();
    void _SlotNo6LineEditWidgetChage();
    void _SlotNo7LineEditWidgetChage();
    void _SlotNo8LineEditWidgetChage();
public:
